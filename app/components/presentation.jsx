...
export default function Presentation({ imageSrc, name, carrer }) {
    return (
    <main className=" hover:bg-black hover:text-white transition-all duration-500 sm:mb-3">
       
    <div className=" sm:mb-3 p-4 border-2 border-black  hover:text-white  ">
        ...
        <a href="resources/CEDULA_PROFESIONAL.pdf" className="flex flex-row-reverse">
